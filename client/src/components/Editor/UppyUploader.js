...
class UppyUploader {
    ...
    for (var i = 0; i < data.length; i++) {
      (function (obj) {
        ...
        columnDiv.setAttribute(
          "style",
          "padding-left:18px;padding-right:18px;flex:1 1 auto"
        );
  ...
  getEmptyDataComponent() {
    ...
    this.nodes.wrapper.replaceChild(
      emptyDataDiv,
      this.nodes.wrapper.children[2]
    );
  }

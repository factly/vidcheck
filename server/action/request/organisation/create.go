...
// @Router /requests/organisations [post]
func Create(w http.ResponseWriter, r *http.Request) {
	...
	err = model.DB.WithContext(context.WithValue(r.Context(), permissionContext, uID)).Model(&model.OrganisationPermissionRequest{}).Create(&result).Error
	if err != nil {
		loggerx.Error(err)

...
// @Router /requests/organisations/{request_id}/reject [post]
func reject(w http.ResponseWriter, r *http.Request) {
	...
	err = model.DB.WithContext(context.WithValue(r.Context(), permissionContext, uID)).Model(&request).Updates(&model.OrganisationPermissionRequest{

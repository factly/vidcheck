...
// @Router /permissions/organisations [post]
func create(w http.ResponseWriter, r *http.Request) {
	...
	var totPerms int64
	model.DB.Model(&model.OrganisationPermission{}).Where(&model.OrganisationPermission{
	...
	model.DB.WithContext(context.WithValue(r.Context(), userContext, uID)).Model(&model.OrganisationPermission{}).Create(&result)
